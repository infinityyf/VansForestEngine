...
//has been defined before, here just declare or function call
...
//only three global level functions
...
INSTANCE_LEVEL_VULKAN_FUNCTION_FROM_EXTENSION(vkGetPhysicalDeviceFeatures2, VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME)
INSTANCE_LEVEL_VULKAN_FUNCTION_FROM_EXTENSION(vkGetPhysicalDeviceProperties2, VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME)
...
DEVICE_LEVEL_VULKAN_FUNCTION(vkCmdFillBuffer)
DEVICE_LEVEL_VULKAN_FUNCTION(vkCmdUpdateBuffer)
...
DEVICE_LEVEL_VULKAN_FUNCTION(vkResetQueryPool)
...
DEVICE_LEVEL_VULKAN_FUNCTION_FROM_EXTENSION(vkGetBufferMemoryRequirements2KHR, VK_KHR_GET_MEMORY_REQUIREMENTS_2_EXTENSION_NAME)
