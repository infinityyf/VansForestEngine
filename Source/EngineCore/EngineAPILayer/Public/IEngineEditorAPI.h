...
namespace Vans::EditorAPI
{
	...
	public:
		...
		virtual PcgEditorOperationResult SelectPcgSpline(const std::string& spline,const std::string& point,bool toolEnabled) = 0;
		...
		virtual PcgEditorOperationResult ApplyPcgPlantConfiguration(const PcgPlantConfiguration& configuration) = 0;
		virtual PcgEditorOperationResult ApplyPcgLayerConfiguration(const PcgBrushTarget& target,const PcgLayerConfiguration& configuration) = 0;
		virtual PcgEditorOperationResult EditPcgConfiguration(const std::string& guid,PcgConfigurationAction action) = 0;
		...
		virtual PcgEditorOperationResult SelectPcgBrushTarget(const PcgBrushTarget& target, bool enabled) = 0;
		...
		virtual PcgInstanceSnapshot GetPcgInstances(const PcgBrushTarget& target,uint64_t offset) = 0;
