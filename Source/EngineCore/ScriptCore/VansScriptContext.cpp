...
{
    _putenv("PYTHONHOME=D:/WorkSpace/githubs/Python-3.13.3/PCbuild/amd64");
    _putenv("PYTHONHOME=D:/WorkSpace/githubs/Python-3.13.3");
    ...
    sys.attr("path").attr("insert")(0, "D:/WorkSpace/ForestEngine/ForestEngine/ForestExporter");
