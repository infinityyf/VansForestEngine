...
{
public:
    static VansPrefabLookup Lookup(EditorAPI::IAssetAuthoringEditorAPI& api);
    ...
    static SceneEditResult Apply(EditorAPI::IAssetEditorAPI& api, VansSceneDocument& document,
