...
{
	std::vector<VkDescriptorSetLayoutBinding> bindings = {
		{SSGI_PROBE_CACHE_BINDING_NORMAL, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 1, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
		{SSGI_PROBE_CACHE_BINDING_DEPTH, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 1, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
		{SSGI_PROBE_CACHE_BINDING_POSITION, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 1, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
		{SSGI_PROBE_CACHE_BINDING_MATERIAL, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 1, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
		{SSGI_PROBE_CACHE_BINDING_SKY_DIFFUSE, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 1, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
		{SSGI_PROBE_CACHE_BINDING_OUTPUT_RADIANCE, VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, 1, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
		{SSGI_PROBE_CACHE_BINDING_OUTPUT_SURFACE, VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, 1, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
		{SSGI_PROBE_CACHE_BINDING_INFO_UBO, VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER, 1, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
		{SSGI_PROBE_CACHE_BINDING_SCREEN_IRRADIANCE, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 8u, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
		{SSGI_PROBE_CACHE_BINDING_GI_VISIBILITY, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 8u, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
		{SSGI_PROBE_CACHE_BINDING_GI_PROBE_STATE, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, 8u, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
		{SSGI_PROBE_CACHE_BINDING_COLOR, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 1u, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
		{SSGI_PROBE_CACHE_BINDING_HIZ_DEPTH, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 1u, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
        {SSGI_PROBE_CACHE_BINDING_HISTORY_SURFACE, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 1u, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
        {SSGI_PROBE_CACHE_BINDING_MOTION_VECTOR, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 1u, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
        {SSGI_PROBE_CACHE_BINDING_HISTORY_INFO, VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER, 1u, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
        {20u, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, 1u, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
        {24u, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, 1u, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
	...
	VkDescriptorSetLayout& outLayout, std::vector<VkDescriptorSet>& outSets, uint32_t setCount)
{
	std::vector<VkDescriptorSetLayoutBinding> bindings = {
		...
		// binding 8: 材质高度的米制强度和距离渐隐参数，仅由细分求值阶段读取。
		{TERRAIN_BINDING_HEIGHT_DETAIL_PARAMS, VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER, 1,
		 VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT, nullptr},
	};
	CreateLayoutAndAllocateSets(bindings, outLayout, outSets, setCount, VansDescriptorLifetimeRole::ScenePersistent);
}
	...
	VkDescriptorSetLayout& outLayout, std::vector<VkDescriptorSet>& outSets, uint32_t setCount)
{
	std::vector<VkDescriptorSetLayoutBinding> bindings = {
		...
		{WATER_GBUF_BINDING_FLOW_MAP, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 1,
		 VK_SHADER_STAGE_VERTEX_BIT, nullptr},
		// 河流使用独立的局部波包。
        {WATER_GBUF_BINDING_RIVER_PARTICLES,VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,1,VK_SHADER_STAGE_VERTEX_BIT|VK_SHADER_STAGE_FRAGMENT_BIT,nullptr},
