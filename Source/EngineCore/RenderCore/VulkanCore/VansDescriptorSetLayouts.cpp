	...
	VkDescriptorSetLayout& outLayout, std::vector<VkDescriptorSet>& outSets, uint32_t setCount)
{
	std::vector<VkDescriptorSetLayoutBinding> bindings = {
		...
		{SSGI_BINDING_SCREEN_IRRADIANCE, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 8u, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
	...
	VkDescriptorSetLayout& outLayout, std::vector<VkDescriptorSet>& outSets, uint32_t setCount)
{
	std::vector<VkDescriptorSetLayoutBinding> bindings = {
		...
		// Binding 10 is the native descriptor-indexed path.  Bindings 11-17 are
		// intentionally retained so an older cached SPIR-V can still use the same
		// layout instead of failing pipeline creation or silently losing GI.
		{10, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, 8u, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
		{11, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, 1u, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
		{12, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, 1u, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
		{13, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, 1u, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
		{14, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, 1u, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
		{15, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, 1u, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
		{16, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, 1u, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
		{17, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, 1u, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
	...
	VkDescriptorSetLayout& outLayout, std::vector<VkDescriptorSet>& outSets, uint32_t setCount)
{
	std::vector<VkDescriptorSetLayoutBinding> bindings = {
		...
		{GIPL_BINDING_PROBE_STATE,     VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,         1, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
	};
	CreateLayoutAndAllocateSets(bindings, outLayout, outSets, setCount, VansDescriptorLifetimeRole::ScenePersistent);
}
	...
	VkDescriptorSetLayout& outLayout, std::vector<VkDescriptorSet>& outSets, uint32_t setCount)
{
	std::vector<VkDescriptorSetLayoutBinding> bindings = {
		...
		{SSGI_ATROUS_BINDING_DEPTH, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 1, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
	...
	VkDescriptorSetLayout& outLayout, std::vector<VkDescriptorSet>& outSets, uint32_t setCount)
{
	std::vector<VkDescriptorSetLayoutBinding> bindings = {
		...
		{GI_VISIBILITY_BINDING_SCREEN_IRRADIANCE, VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, 1, VK_SHADER_STAGE_COMPUTE_BIT, nullptr},
	};
	CreateLayoutAndAllocateSets(bindings, outLayout, outSets, setCount, VansDescriptorLifetimeRole::ScenePersistent);
}
